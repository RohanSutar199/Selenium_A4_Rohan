...
public class Base_Test {
	...
	public WebDriver_Utility webdriverDriverUtility = new WebDriver_Utility();
...
//		String url = fileUtility.readDataFromPropertyFile("url");
	...
	//	webdriverDriverUtility.javascriptClick(driver, homePage.getAccountSettingsBtn());
		homePage.getAccountSettingsBtn().click();
	//	webdriverDriverUtility.javascriptClick(driver, homePage.getLogOutBtn());
